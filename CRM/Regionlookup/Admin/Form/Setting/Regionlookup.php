...
class CRM_Regionlookup_Admin_Form_Setting_Regionlookup extends CRM_Admin_Form_Setting {
  ...
  public function buildQuickForm() {
    ...
    $this->addRadio('lookup_method', ts("Lookup method"), $lookup_methods, NULL, NULL, TRUE);
  ...
  public function postProcess() {
    ...
    // Lookup method
    $store_settings['other']['lookup_method'] = $params['lookup_method'];

    // Store the settings
    Civi::settings()->set('regionlookup_settings', $store_settings);

    CRM_Core_Session::setStatus(ts('Configuration settings have been saved.'), '', 'success');
  }
